...
%cm = 0.4; %% 1 cm = 0.4 in
cm = 0.3937*20; %% 1 cm = 0.4 in, including the scaleing factor
%% general 
clear freq Pset
npsim=16001;
freq=linspace(3.95E9,5.85E9,npsim);
...
% ldname=['F:\Shukai\RCM z\znorm_' num2str(nom) 'a1p_9d7.mat']
% load(ldname);
%%
[n,m]=size(Z_rr);
...
fig3=plot(imxv2_rcmf,imyv2_rcmf,'o','DisplayName','rcm');
%title('PWB-RCM hybrid model, 2cav induced power, scaled');
title('2cav induced voltage, full scale, 6 absorbers');
